    ...
    routes: [
        ...
        },
        {
            ...
            },
            {
                path: '/IndexBanner',
                name: 'IndexBanner',
                component: resolve => require(['../views/IndexBanner.vue'], resolve),
                meta: ['首页管理', 'Banner图片']
            },
            {
                path: '/BargainInfo',
                name: 'BargainInfo',
                component: resolve => require(['../views/BargainInfo.vue'], resolve),
                meta: ['一元活动', '活动详情']
            },
            {
                path: '/BargainRole',
                name: 'BargainRole',
                component: resolve => require(['../views/BargainRole.vue'], resolve),
                meta: ['活动规则', '活动规则']
            },
            {
                path: '/AllRelative',
                name: 'AllRelative',
                component: resolve => require(['../views/AllRelative.vue'], resolve),
                meta: ['活动名称', '活动商品列表']
            },
            {
                path: '/bindTabs',
